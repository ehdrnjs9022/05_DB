...
ALTER TABLE DEPT_COPY
MODIFY DEPT_TITLE VARCHR2(10);
-- 일부 값이 너무 커서 열 길이를 줄일수 없다
 --> 이미 저장된 값 보다 작은 크기로 자료형으로 변경 불가!!
...
-- DDL(CREATE)이 트랙잭션()을 밍렁서 DB에 반영해버림(원래는 COMMIT 했을때 반영임)
